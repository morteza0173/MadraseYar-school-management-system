...
import { AnnouncementDataTableToolbar } from "./AnnouncementDataTableToolbar";
...
interface DataTableProps<TData, TValue> {
  ...
  announcementsRefetch: UseQueryResult<TData[]>["refetch"];
}

const MotionTableRow = motion.create(TableRow);

export function AnnouncementListDataTable<TData, TValue>({
  columns,
  data,
  ...
  return (
    <div className="space-y-2 ">
      <AnnouncementDataTableToolbar table={table} />
