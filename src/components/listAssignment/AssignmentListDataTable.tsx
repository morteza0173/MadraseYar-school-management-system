...
import { AssignmentDataTableToolbar } from "./AssignmentDataTableToolbar";

interface DataTableProps<TData, TValue> {
  columns: ColumnDef<TData, TValue>[];
  data: TData[];
  isAssignmentsError: boolean;
  isAssignmentsPending: boolean;
  assignmentsRefetch: UseQueryResult<TData[]>["refetch"];
}

const MotionTableRow = motion.create(TableRow);

export function AssignmentListDataTable<TData, TValue>({
  columns,
  data,
  isAssignmentsError,
  ...
  return (
    <div className="space-y-2 ">
      <AssignmentDataTableToolbar table={table} />
