...
export function EventDataTableToolbar<TData>({
  table,
  ...
  return (
    <>
      <ResponsiveModalForm
        ...
        close={closeDelete}
        title="حذف رویداد های انتخاب شده"
        discription="میتوانید به صورت یکجا رویداد های انتخاب شده را حذف کنید"
      >
        <DeleteEventsForm onCancel={closeDelete} ids={selectedIds} />
      </ResponsiveModalForm>
