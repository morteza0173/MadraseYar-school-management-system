...
import { EventDataTableToolbar } from "./EventDataTableToolbar";
...
interface DataTableProps<TData, TValue> {
  ...
  eventsRefetch: UseQueryResult<TData[]>["refetch"];
}

const MotionTableRow = motion.create(TableRow);

export function EventListDataTable<TData, TValue>({
  columns,
  data,
  isEventsError,
  isEventsPending,
  ...
  return (
    <div className="space-y-2 ">
      <EventDataTableToolbar table={table} />
