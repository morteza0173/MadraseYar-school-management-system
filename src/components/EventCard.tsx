...
const EventList = () => {
  return (
    <div className="w-[94%] h-16 odd:bg-yellow-200 even:bg-sky-200 rounded-lg mt-2 flex items-center p-2 mr-2">
      <p className="text-xs">9:00 صبح</p>
      <Separator
        orientation="vertical"
        className="w-1 rounded-full bg-white mr-4"
      />
