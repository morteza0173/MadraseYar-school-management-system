...
import { StudentDataTableToolbar } from "./StudentDataTableToolbar";
...
interface DataTableProps<TData, TValue> {
  ...
  data: TData[];
  isStudentDataError: boolean;
  isStudentDataPending: boolean;
  studentDataRefetch: UseQueryResult<TData[]>["refetch"];
}
