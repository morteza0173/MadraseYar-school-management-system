...
import { ExamDataTableToolbar } from "./ExamDataTableToolbar";

interface DataTableProps<TData, TValue> {
  columns: ColumnDef<TData, TValue>[];
  data: TData[];
  isExamsError: boolean;
  isExamsPending: boolean;
  examsRefetch: UseQueryResult<TData[]>["refetch"];
}

const MotionTableRow = motion.create(TableRow);

export function ExamListDataTable<TData, TValue>({
  columns,
  data,
  isExamsError,
  isExamsPending,
  ...
  return (
    <div className="space-y-2 ">
      <ExamDataTableToolbar table={table} />
