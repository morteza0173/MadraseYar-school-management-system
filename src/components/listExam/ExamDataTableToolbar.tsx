...
import { ExamDataTableViewOptions } from "./ExamDataTableViewOptions";
import DeleteExamsForm from "./DeleteExamsForm";
...
export function ExamDataTableToolbar<TData>({
  table,
  ...
  return (
    <>
      ...
      >
        <DeleteExamsForm onCancel={closeDelete} ids={selectedIds} />
      </ResponsiveModalForm>
      <div className="flex flex-wrap items-center justify-between">
        ...
        <div className="flex items-center gap-2 w-full md:w-auto mt-2 md:mt-0">
          ...
          <ExamDataTableViewOptions table={table} />
        </div>
      </div>
    </>
  );
