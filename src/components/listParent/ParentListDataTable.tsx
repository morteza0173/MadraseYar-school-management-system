...
import { ParentDataTableToolbar } from "./ParentDataTableToolbar";
...
interface DataTableProps<TData, TValue> {
  ...
  data: TData[];
  isParentDataError: boolean;
  isParentDataPending: boolean;
...
useEffect(() => {
  ...
  return (
    <div className="space-y-2 ">
      <ParentDataTableToolbar table={table} />
